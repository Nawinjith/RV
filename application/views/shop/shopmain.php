    ...
    <div class="d-flex align-items-stretch">
      <div id="sidebar" class="sidebar py-3">
        ...
        <ul class="sidebar-menu list-unstyled">
              ...
              <li class="sidebar-list-item"><a href="<?php echo base_url(); ?>index.php/shop/viewStock" class="sidebar-link text-muted"><i class="o-database-1 mr-3 text-gray"></i><span>Stock Status</span></a></li>

              <li class="sidebar-list-item"><a href="<?php echo base_url('index.php/products'); ?>" class="sidebar-link text-muted"><i class="o-wireframe-1 mr-3 text-gray"></i><span>Add New Order</span></a></li>
              <li class="sidebar-list-item"><a href="<?php echo base_url('index.php/shop/feedback'); ?>" class="sidebar-link text-muted"><i class="o-survey-1 mr-3 text-gray"></i><span>Provide Feedback</span></a></li>
