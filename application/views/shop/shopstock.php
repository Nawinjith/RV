    ...
    <div class="d-flex align-items-stretch">
      <div id="sidebar" class="sidebar py-3">
        ...
        <ul class="sidebar-menu list-unstyled">
              ...
              <li class="sidebar-list-item"><a href="<?php echo base_url(); ?>index.php/shop/viewStock" class="sidebar-link text-muted active"><i class="o-database-1 mr-3 text-gray"></i><span>Stock Status</span></a></li>
        ...
        <div class="container-fluid px-xl-5">
          <section class="py-5">
              ...
              <div class="col-lg-12 mb-4">
                <div class="card">
                  <div class="card-header">
                    <h6 class="text-uppercase mb-0">CURRENT STOCK STATUS</h6>
                  </div>
                  <div class="card-body">                           
            ...
            <tbody>
                ...
                <td>insert</td>
                <td>insert</td>
                <td> <a href="#"><button type="button" class="btn btn-secondary">Edit</button></a> 
          ...
          <section class="py-5">
            <div class="row">
              ...
              <div class="col-lg-12 mb-4">
                <div class="card">
                  <div class="card-header">
                    <h6 class="text-uppercase mb-0">DELIVERIES PENDING</h6>
                  </div>
                  <div class="card-body">                           
                    <table class="table table-striped table-hover card-text">
                    <thead class="thead-dark">
            ...
            <tbody>
                ...
                <td>insert</td>
                <td>insert</td>
                <td> <a href="#"><button type="button" class="btn btn-secondary">Recieved</button></a> 
                    <a href="<?php echo base_url(); ?>index.php/shop/feedback"><button type="button" class="btn btn-secondary">Feedback</button></a>
                </td>   
                </tr>
