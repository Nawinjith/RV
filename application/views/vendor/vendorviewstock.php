    ...
    <div class="d-flex align-items-stretch">
      <div id="sidebar" class="sidebar py-3">
        ...
        <ul class="sidebar-menu list-unstyled">
              ...
              <li class="sidebar-list-item"><a href="<?php echo base_url(); ?>index.php/vendor/viewStock" class="sidebar-link text-muted active"><i class="o-database-1 mr-3 text-gray"></i><span>View Stock</span></a></li>
      ...
      <div class="page-holder w-100 d-flex flex-wrap">
        <div class="container-fluid px-xl-5">
         <br>
         <br>
         <h1>include warehouse stock here (vendor view)</h1>
